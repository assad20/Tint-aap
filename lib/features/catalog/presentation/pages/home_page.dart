...
bool _handleSduiAction(
  ...
  /// ‼️ **صفحة CMS منشورة** — `tint://page/<slug>` (المهمّة 3.3).
  ///
  /// وتُفتَح **بالمسار لا بتبديل تبويب**: هي شاشةٌ فوق القشرة، ولا موضع لها
  /// في الشريط العلويّ أصلاً.
  ///
  /// ‼️ **ويُقال `true` بلا فحصٍ مسبق** — بخلاف الأقسام. سببه أنّ الصفحة قد
  /// تُنشر بعد إقلاع التطبيق، وسؤالُ الخادم عن كلّ رابطٍ قبل رسم الزرّ يُضيف
  /// رحلةً لكلّ بنر. والشاشة تُعالج غيابها برسالةٍ مفهومة، وهو أرخص من صمتٍ
  /// يُخفي صفحةً منشورة.
  if (action.type == 'page') {
