...
/// لوحة خريطةٍ واحدة فوق محرّكين: خرائط جوجل، أو بلاطات CartoDB المجّانيّة.
///
...
class _TintMapCanvasState extends State<TintMapCanvas> {
  ...
  Widget _buildOsm() {
    return FlutterMap(
      ...
      children: [
        TileLayer(
          /// خريطة CartoDB Positron — رماديّة نظيفة، أقرب ما يكون إلى مظهر
          /// خرائط جوجل بين البدائل المجّانيّة بلا مفتاح.
          ///
          /// ‼️ **مسارها `light_all` لا `rastertiles/positron`.** كارتو تُقدّم
          /// «فويجر» تحت `rastertiles/` و«بوزيترون» تحت اسمها القديم — وتخمين
          /// المسار بالقياس يُعيد 404 لكلّ بلاطة، فتظهر **خريطةٌ رماديّة صامتة**
          /// لا رسالةَ خطأ. (رُصد على المحاكي 2026-08-25.)
          urlTemplate:
