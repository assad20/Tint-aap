...
/// ‼️ **لا تُوصَل منتجات هذا الملفّ بالواجهة.**
///
/// كانت تُعرض كتراجُعٍ متى جاء قسمٌ فارغاً من الخادم — في الرئيسيّة، وفي رفّ
/// السلّة، وفي نتائج البحث. ومنتجاتها **لا وجود لها في الكتالوج**، فمن يضيفها
/// لا يستطيع شراءها: الخادم لا يعرف معرّفها فيرفض الطلب. قبل حارس المخزون كان
/// المشتري يدفع ثمّ يُرفض؛ والآن يُردّ عند السلّة. **وقسمٌ فارغ أصدق من قسمٍ
/// يعرض ما لا يُباع.**
///
/// المستعمَل الوحيد الباقي هو `defaultAssistantMessages` — نصّ ترحيبٍ لا بضاعة.
/// وبقيّة ما هنا ميّت؛ يُحذف حين يُتأكّد ألّا مرجع له.
class FakeSeedData {
